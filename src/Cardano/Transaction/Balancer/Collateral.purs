...
import Cardano.Transaction.Balancer.Collateral.Select (minRequiredCollateral) as X
import Cardano.Transaction.Balancer.Error
  ( BalanceTxError(NumericOverflowError, CollateralReturnError)
  )
import Cardano.Transaction.Balancer.Types (BalanceTxM, askCoinsPerUtxoUnit)
...
addTxCollateralReturn collateral transaction ownAddress = do
  ...
  setTxCollateralReturn collAdaValue collMultiAsset = do
    ...
    let
      ...
      minAdaValue = utxoMinAdaValue coinsPerUtxoUnit returnAsTxOut
