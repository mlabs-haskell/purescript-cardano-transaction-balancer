...
-- | of over-selection.
module Cardano.Transaction.Balancer.CoinSelection
...
import Cardano.Transaction.Balancer.CoinSelection.UtxoIndex
  ( SelectionFilter(SelectSingleton, SelectAnyWith, SelectPairWith)
  , TxUnspentOutput
  , UtxoIndex
  , emptyUtxoIndex
...
import Cardano.Transaction.Balancer.Types.Val (Val)
...
import Data.Map (empty, insert, keys) as Map
